...
export default function ManagerDashboard() {
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-foreground">Shop Manager Dashboard</h1>
      <Card>
        <CardHeader>
          <CardTitle>Shop Configuration</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Manage your shop settings and staff access here.</p>
