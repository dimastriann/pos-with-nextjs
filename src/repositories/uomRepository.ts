...
export const uomRepository = {
  getAll: (): Promise<Uom[]> => adapter.getAll<Uom>(RESOURCE_KEYS.UOM),
  ...
  update: (data: Uom): Promise<Uom> => adapter.update(RESOURCE_KEYS.UOM, data),

  delete: (id: string): Promise<void> => adapter.delete(RESOURCE_KEYS.UOM, id),
};
