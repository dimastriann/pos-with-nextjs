      ...
      <Card className="print:shadow-none">
        <CardContent className="p-6">
          ...
          <div className="text-center mb-4">
            <h1 className="text-xl font-bold text-foreground">{state.activeShop?.name ?? 'POS Flow'}</h1>
            {state.activeShop?.address && (
              <p className="text-xs text-muted-foreground">{state.activeShop.address}</p>
            )}
            <p className="text-xs text-muted-foreground mt-1">{new Date(order.date).toLocaleString()}</p>
          ...
          <p className="text-center text-xs text-muted-foreground mb-4">Thank you for your purchase!</p>
